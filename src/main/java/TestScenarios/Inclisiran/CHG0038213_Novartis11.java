...
public class CHG0038213_Novartis11 extends BaseTestClass {

    @Test
    public void createTask() throws Exception{

        ExcelReader excelReader = new ExcelReader();
        excelReader.readExcel("Novartis11");
        ...
        List<String> srValues = SrTypeListValidation.getSRTypeList();

        for (String s: srValues) {
            create.selectSRtype(s);
        }
