...
public class Register_Prescriber_ExistingNPI extends HCPBaseTestClass {
    ...
    Register Prescriber with Existing NPI
    */
    ...
    public void register() throws Exception{
        ...
        excelReader.readExcel("RegisterPrescriberWithExistNPI");
