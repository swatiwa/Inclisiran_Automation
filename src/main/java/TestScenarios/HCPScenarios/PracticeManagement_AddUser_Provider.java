...
public class PracticeManagement_AddUser_Provider extends HCPBaseTestClass {
    ...
    */
    ...
    @Test
    public void addProviderUser() throws Exception{

        ExcelReader excelReader = new ExcelReader();

        logger.info("Reading data from PracticeManagement_Add_User_Provider sheet");
        excelReader.readExcel("PM_Add_User_Provider");
        ...
        logger.info("Selecting 'Provider' user role and Inputting all required user information");
        ...
        practiceManagement.enterPrescriberNPI(excelReader.testData.get("UserNPI"));

        logger.info("Clicking 'Add User and Close' button");
        practiceManagement.clickAddUserAndClose();

        logger.info("Verifying we have received email with the account access link");
