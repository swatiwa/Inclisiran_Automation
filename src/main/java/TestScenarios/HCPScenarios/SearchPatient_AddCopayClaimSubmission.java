...
public class SearchPatient_AddCopayClaimSubmission extends HCPBaseTestClass {
    ...
    /*
     ...
     Add Copay Claim Submission service request
     */

    @Test
    public void createCopayClaimSubmissionRequest() throws Exception {
        ...
        newRequestPage.selectCopayClaimSubmission();
        ...
        //put 'Patient Info' verification steps
        patientPage.clickNext();
        ...
        prescriberPage.selectPayment(excelReader.testData.get("PaymentMethod"));
        patientPage.clickNext();
